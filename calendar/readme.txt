...
Open main.php file and then click the links to display calendar. Select any date from calendar to pass the value to text field. 

If your week starts from Monday then use cal3.php file inplace of cal2.php 
For yearly calendar with Monday as week start day then use year-calendar-2017.php file